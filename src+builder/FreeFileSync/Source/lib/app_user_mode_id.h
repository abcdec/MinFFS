...
// * This file is part of a modified version of FreeFileSync, the MinFFS.   *
...
#ifndef LIB_APP_USER_MODE_ID_H_INCLUDED
#define LIB_APP_USER_MODE_ID_H_INCLUDED



#endif//LIB_APP_USER_MODE_ID_H_INCLUDED
