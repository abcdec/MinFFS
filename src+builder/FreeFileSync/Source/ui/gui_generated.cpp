...
AboutDlgGenerated::AboutDlgGenerated( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    m_hyperlink11 = new wxHyperlinkCtrl( m_panel41, wxID_ANY, _("MinGW"), wxT("http://www.mingw.org"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
    m_hyperlink11->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_WINDOW ) );
    m_hyperlink11->SetToolTip( _("http://www.mingw.org") );
    ...
    m_bitmapEmail->SetToolTip( _("Contact") );
    ...
    m_hyperlink2->SetToolTip( _("https://github.com/abcdec/MinFFS/issues") );
