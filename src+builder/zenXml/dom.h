...
public:
    ...
    //Therefore at least prevent users from calling it via private dummy type PrivateConstructionTag
    template <class String>
    XmlElement(const String& name, XmlElement* parentElement, PrivateConstructionTag) : name_(utfCvrtTo<std::string>(name)), parent_(parentElement) {}
    ...
    */
    ...
    XmlElement& addChild(const String& name)
    {
        ...
        auto newElement = std::make_shared<XmlElement>(utf8Name, this, PrivateConstructionTag());
...
public:
    ...
    XmlDoc() : version_("1.0"), encoding_("UTF-8"), rootElement("Root", nullptr, XmlElement::PrivateConstructionTag()) {}

    XmlDoc(XmlDoc&& tmp) : rootElement("Root", nullptr, XmlElement::PrivateConstructionTag()) { swap(tmp); }
    ...
    */
    template <class String>
    XmlDoc(String rootName) : version_("1.0"), encoding_("UTF-8"), rootElement(rootName, nullptr, XmlElement::PrivateConstructionTag()) {}
